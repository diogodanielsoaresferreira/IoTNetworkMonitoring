...
def main():
	...
	Classes = {0: "regularTraffic", 1: "Scenario1     ", 2: "Scenario2     "}

	regular_traffic = np.loadtxt('sensor1_results/out_sensor1_regular_n2.txt')
	scenario_1 = np.loadtxt('sensor1_results/out_sensor1_s1_n2.txt')
	scenario_2 = np.loadtxt('sensor1_results/out_sensor1_s2_n2.txt')
	...
	for iteration in range(numberIterations):
		...
		trainFeatures=np.vstack((trainFeatures_regular, trainFeatures_scenario1, trainFeatures_scenario2))
		...
		trainFeaturesS=np.vstack((trainFeatures_regularS, trainFeatures_scenario1S, trainFeatures_scenario2S))
		...
		trainFeaturesW=np.vstack((trainFeatures_regularW, trainFeatures_scenario1W, trainFeatures_scenario2W))
		trainFeaturesW = np.nan_to_num(trainFeaturesW)

		allTrainFeatures=np.hstack((trainFeatures,trainFeaturesS,trainFeaturesW))
		trainClass=np.vstack((oClass_rt, oClass_scenario1, oClass_scenario2))
		...
		testFeatures=np.vstack((testFeatures_regular, testFeatures_scenario1, testFeatures_scenario2))
		...
		testFeaturesS=np.vstack((testFeatures_regularS, testFeatures_scenario1S, testFeatures_scenario2S))
		...
		testFeaturesW=np.vstack((testFeatures_regularW, testFeatures_scenario1W, testFeatures_scenario2W))
		testFeaturesW = np.nan_to_num(testFeaturesW)

		allTestFeatures=np.hstack((testFeatures,testFeaturesS,testFeaturesW))
		oClass=np.vstack((oClass_rt, oClass_scenario1, oClass_scenario2))
	...
	SVC_metrics = np.sum(SVC_metrics.reshape(numberIterations, 3, 3), axis=0)
	...
	RBF_metrics = np.sum(RBF_metrics.reshape(numberIterations, 3, 3), axis=0)
	...
	Poly_metrics = np.sum(Poly_metrics.reshape(numberIterations, 3, 3), axis=0)
	...
	SVC2_metrics = np.sum(SVC2_metrics.reshape(numberIterations, 3, 3), axis=0)
	...
	neural_network = np.sum(neural_network.reshape(numberIterations, 3, 3), axis=0)
