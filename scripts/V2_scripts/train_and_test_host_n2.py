...
def main():
	...
	regular_traffic = np.loadtxt('host_results/out_host_regular_n2.txt')
	scenario_1 = np.loadtxt('host_results/out_host_s1_n2.txt')
	scenario_2 = np.loadtxt('host_results/out_host_s2_n2.txt')
