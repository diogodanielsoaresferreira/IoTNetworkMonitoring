...
def main():
	...
	Classes = {0: "regularTraffic", 1: "Scenario3     "}

	regular_traffic = np.loadtxt('sensor2_results/out_sensor2_regular_l2_n1.txt')
	scenario_3 = np.loadtxt('sensor2_results/out_sensor2_s3_l2_n1.txt')
