...
def main():
	...
	regular_traffic = np.loadtxt('host_results/out_host_regular_l2_n1.txt')
	scenario_1 = np.loadtxt('host_results/out_host_s1_l2_n1.txt')
	scenario_2 = np.loadtxt('host_results/out_host_s2_l2_n1.txt')
	scenario_3 = np.loadtxt('host_results/out_host_s3_l2_n1.txt')
