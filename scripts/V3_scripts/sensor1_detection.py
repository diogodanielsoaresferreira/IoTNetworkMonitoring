...
def main():
	...
	regular_traffic = np.loadtxt('../sensor1_results/out_sensor1_regular_l2_n3.txt')
	scenario_1 = np.loadtxt('../sensor1_results/out_sensor1_a1_l2_n3.txt')
	scenario_2 = np.loadtxt('../sensor1_results/out_sensor1_a2_l2_n3.txt')
	scenario_3 = np.loadtxt('../sensor1_results/out_sensor1_a3_l2_n3.txt')
