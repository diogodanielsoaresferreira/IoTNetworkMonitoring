...
def main():
	...
	regular_traffic = np.loadtxt('../sensor2_results/out_sensor2_regular_l2_n3.txt')
	scenario_1 = np.loadtxt('../sensor2_results/out_sensor2_a1_l2_n3.txt')
	scenario_2 = np.loadtxt('../sensor2_results/out_sensor2_a2_l2_n3.txt')
	scenario_3 = np.loadtxt('../sensor2_results/out_sensor2_a3_l2_n3.txt')
