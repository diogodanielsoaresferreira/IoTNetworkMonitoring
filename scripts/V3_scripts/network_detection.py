...
def main():
	...
	regular_traffic = np.loadtxt('../network_results/out_net_regular_l2_n3.txt')
	scenario_1 = np.loadtxt('../network_results/out_net_a1_l2_n3.txt')
	scenario_2 = np.loadtxt('../network_results/out_net_a2_l2_n3.txt')
	scenario_3 = np.loadtxt('../network_results/out_net_a3_l2_n3.txt')
